...
@Service
public class ProxyConcesionario {

        //Constante con la URL del servicio rest al que vamos a acceder
        public static final String URL_COCHES = "http://localhost:8080/CochesarrayCoches/";
        ...
        public Coche alta(Coche persona) {
            RestTemplate restTemplate = new RestTemplate();
            ...
            HttpEntity<Coche> requestBody = new HttpEntity<>(persona);
        ...
        public Coche modificar(Coche persona) {
            RestTemplate restTemplate = new RestTemplate();
            ...
            ResponseEntity<Coche> response = 
                    restTemplate.exchange(URL_COCHES + persona.getId(), 
                            HttpMethod.PUT, 
                            requestBody, 
                            Coche.class);
